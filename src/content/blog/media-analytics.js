...
( () => {
    ...
    ( () => {
        ...
        const b = "production"
          , m = "0.0.475"
          , h = "417a2555wec646399p8179bc53m9a4f51a3"
          , w = "s417a2555wec646399p8179bc53m9a4f51a3m.js";
        var v = r(3482)
          , g = r.n(v);
                ...
                j(document, "cookie", {
                    ...
                    set: function(t) {
                        const i = t.split(";").map((e => e.trim())).find((e => e.startsWith("domain=")))
                          , o = i?.split("=")[1] || "";
                        if (r.find((e => new RegExp(`^\\.?${e}$`).test(o))))
                            return;
                        const a = n.getValue();
...
globalThis.shopify = self.webPixelsManager.createShopifyExtend('746029421', 'app');
importScripts('/wpm/strict/app/web-pixel-746029421@8c292b77d3f5d6f0d2e16741d41166cb.js');
...
( () => {
    ...
    ;
    var P = (e, t, o) => (o = e != null ? y(O(e)) : {},
    _(t || !e || !e.__esModule ? u(o, "default", {
        value: e,
        enumerable: !0
    }) : o, e));
    var p = (e, t, o) => new Promise( (n, r) => {
        var i = a => {
            try {
                c(o.next(a))
            } catch (m) {
          ...
          , c = a => a.done ? n(a.value) : Promise.resolve(a.value).then(i, h);
    ...
    var k = T(d => {
        N();
        f( ({analytics: e, init: t, settings: o, browser: n}) => {
            e.subscribe("page_viewed", r => {
                p(d, null, function*() {
                    let i = encodeURIComponent(t.context.document.location.href)
                      , h = encodeURIComponent(t.context.document.referrer)
                      , c = "avmws"
                      , a = yield x(n, c)
                      , m = yield fetch(o.url + "/shopify_visit.php?url=" + i + "&ref=" + h + "&avmws=" + a + "&merchantId=" + o.merchantId + "&shopName=" + o.shopName, {
                        method: "GET"
                    }).then(s => s.text()).then(s => s);
                    if (m.length !== 0) {
                        let s = c + "=" + m;
                        yield n.cookie.set(s),
                        yield n.localStorage.setItem(c, m.split(";")[0])
                    }
                }).catch(console.error)
            }
            ),
            e.subscribe("checkout_completed", r => {
                p(d, null, function*() {
                    let i = r.data.checkout
                      , h = "avmws"
                      , c = encodeURIComponent(t.context.document.location.href)
                      , a = encodeURIComponent(t.context.document.referrer)
                      , m = yield x(n, h)
                      , s = {
        ...
        var x = (e, t) => p(d, null, function*() {
            let o = yield e.localStorage.getItem(t);
            return o == null && (o = yield e.cookie.get(t)),
            o || ""
        })
    }
    );
